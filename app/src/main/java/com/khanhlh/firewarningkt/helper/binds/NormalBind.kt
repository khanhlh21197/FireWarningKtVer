...
import com.khanhlh.firewarningkt.view.base.Presenter
...
fun bindLoadMore(
    v: androidx.recyclerview.widget.RecyclerView,
    vm: PagedViewModel?,
    presenter: Presenter
) {
...
fun bindSlider(v: androidx.recyclerview.widget.RecyclerView, vertical: Boolean = true) {
    ...
    if (vertical) {
        v.layoutManager = androidx.recyclerview.widget.LinearLayoutManager(
            v.context,
